    ...
    <form method="post">
        ...
        <div>
            ...
            <select name="module" required>
                ...
                <option value="Tableur "> Tableur (Conception d'utilitaire de gestion en Compte, QHSE, FINANCE, Logistique...)</option>
        ...
        <!--------------formation_et_cout-------------------------->
        <div>
            <label for="tariff">Type de Formation et coût</label><br>
            ...
            <select name="tariffe" required>
                ...
                <option>Formation a Accélérer pour un(1) Module(20H): 75 000F CFA/ Module</option>
                <option>Formation a Accélérer a Domicile pour un(1) Module(20H): 100 000F CFA/ Module</option>
                <option>Autre</option>
            </select>
        </div><br>
