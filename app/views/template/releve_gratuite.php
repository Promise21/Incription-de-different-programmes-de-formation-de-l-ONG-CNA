...
<section class="content-section container text-center" >
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="blue" class="bi bi-arrow-left" viewBox="0 0 16 16">
    ...
    <table class="table table-primary caption-top" border="2" cellpadding="5" cellspacing="1">
