...
<body id="page-top">
    ...
    <nav id="sidebar-wrapper">
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-item"><a href="Admin_login">Admin</a></li>
        </ul>
    </nav>
    <!-- style de logo -->
    <style>
    ...
    <header class="masthead d-flex align-items-center">
        <div class="container px-4 px-lg-5 text-center">
            ...
            <h2>Caravane Numerique Africaine</h2>
            <p class="lead mb-5">
                l'ONG CNA est une organisation qui s'occupe principalement dans l'apprentissage
            ...
            <div class="row gx-4 gx-lg-5">
                ...
                <div class="col-lg-3 col-md-6 mb-5 mb-lg-0">
                    ...
                    <a href="inscription_bureautique">
                        <p class="text-faded mb-0">Formation Productivite en Enterprise</p>
                    </a>
                </div>
                <!-- formation technique -->
                    ...
                    <a class="portfolio-item" href="#!">
                        <div class="caption">
                            <div class="caption-content">
                                ...
                                <p class="mb-0">C'est un programme de reinsertion dans le numerique pour les detenu!</p>
                            </div>
                        </div>
